...
const Homepage = () => {
    return (
        <div className="main-container fadeIn">
            ...
            <Header />
            <section
                className="carousel-container w-full sm:h-72 md:h-80 lg:h-96 h-40"
            >
                <ImageCarousel />
            </section>
                    ...
                    <div className="flex lg:flex-row md:flex-row flex-wrap flex-col sm:-mx-3 mt-4">
                        ...
                        >
                            <Card className="mb-8 h-full">
                                ...
                                <img
                                    className="m-auto mt-4 h-40"
                                    src={outlet}
                                    alt="outlets"
                                />
                                <p className="mt-4">
                                    <p className="mt-4">
                                        We’ve teamed up with amazing outlets to
                                        keep the saving and more .
                                    </p>
                                </p>
                            </Card>
                        </div>
                        ...
                        >
                            <Card className="mb-8 h-full">
                                ...
                                />
                                <p className="mt-4">
                                    Members save from LFS Card Offers .
                                </p>
                            </Card>
                        </div>
                        ...
                        >
                            <Card className="mb-8 h-full">
                                ...
                                />
                                <p className="mt-4">
                                    Shop anywhere with us , enjoy our exclusive
                        ...
                        >
                            <Card className="mb-8 h-full">
                                ...
                                />
                                <p className="mt-4">
                                    Visit our outlets again and again to save
                                    more .
                                </p>
                            </Card>
                        </div>
